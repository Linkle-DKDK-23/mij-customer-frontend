...
export default function CreatorProfile() {
    ...
    const tabs = [
        { id: 'posts', label: `投稿`, count: mockPosts.length },
        { id: 'plans', label: `プラン`, count: mockPlans.length },
        { id: 'individual', label: `単品購入`, count: mockIndividualPurchases.length },
        { id: 'gacha', label: `ガチャ`, count: mockGachaItems.length }
    ];
    const renderContent = () => {
        switch (activeTab) {
            case 'posts':
                return _jsx(PostsSection, { posts: mockPosts });
            case 'plans':
                return _jsx(PlansSection, { plans: mockPlans });
            case 'individual':
                return _jsx(IndividualPurchaseSection, { items: mockIndividualPurchases });
            case 'gacha':
                return _jsx(GachaSection, { items: mockGachaItems });
            default:
                return _jsx(PostsSection, { posts: mockPosts });
        }
    };
    return (_jsx("div", { className: "flex flex-col items-center justify-center", children: _jsxs("div", { className: "w-full max-w-lg bg-white space-y-6 mb-20", children: [_jsx(CreatorHeader, { creator: mockCreator }), _jsx("section", { className: "bg-white border-b border-gray-200 py-6", children: _jsx(PlanArea, { plans: mockPlans }) }), _jsx("section", { className: "bg-white border-b border-gray-200 py-6", children: _jsx(GachaPlan, { items: mockGachaItems }) }), _jsx("section", { className: "bg-white border-b border-gray-200", children: _jsx(TabsSection, { activeTab: activeTab, setActiveTab: setActiveTab, tabs: tabs }) }), _jsx("section", { className: "py-8", children: renderContent() }), _jsx(BottomNavigation, {})] }) }));
}
