        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-black">第5条（プライバシー情報の第三者提供）</h2>
                <div className="text-base sm:text-lg leading-relaxed">
                （1）当社は、ユーザーの個人情報を第三者に開示または提供する場合、その提供先・提供情報内容を開示し、ユーザー本人の同意を得るものとします。なお、当社は、以下の場合を除き、ユーザー本人の事前の同意を得ることなく、個人情報を第三者に開示または提供することはありません。<br/>
                  <div className="ml-4 sm:ml-6 mt-2 space-y-1">
                    <div>1. 法令等の定めに基づいて開示等を請求された場合</div>
                    <div>2. 弁護士、検察、警察等から捜査に必要な範囲で開示等を請求された場合</div>
                    <div>3. 当社の関連会社間で情報を共有する場合</div>
                    <div>4. 本サービスの提供に必要な範囲で第三者に業務の一部を委託する場合</div>
                    <div>5. 本サービスの提供に必要な範囲内で決済代行会社に情報を提供する必要がある場合</div>
                    <div>（2）当社は、合併や分割等で当社の事業を第三者に譲渡する場合または本サービスの一部または全部を第三者に譲渡する場合、本サービスに係るユーザーの個人情報等を当該第三者に提供します。</div>
                  </div>
                </div>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-black">第6条（年齢確認・本人確認）</h2>
                <div className="text-base sm:text-lg leading-relaxed">
                  （1）本サービスの登録・利用は18歳以上に限ります。<br/>
                  （2）当社は、年齢確認のため、顔写真付き公的身分証（運転免許証、在留カード、パスポート等）の画像およびセルフィ（本人撮影画像）、生年月日その他当社所定の情報の提出を求めることがあります。<br/>
                  （3）個人番号（マイナンバー）の取得・保管は行いません。マイナンバーカードの番号記載面の提出は禁止します。<br/>
                  （4）当社は、提出情報に不足・不整合がある場合、追加書類の提出又は再提出を求めることができ、確認が完了するまでアカウントの利用制限・支払保留等の措置を行うことができます。<br/>
                  （5）当社は、リスク低減のため、同一人物による重複登録の確認その他の不正対策を目的として、提出情報をハッシュ化等の方法で照合することがあります。
                </div>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-black">第7条（本人確認情報の保管・削除）</h2>
                <div className="text-base sm:text-lg leading-relaxed">
                  （1）当社は、本人確認書類の画像データについては審査目的の範囲でのみ利用し、審査完了後は当社ポリシーに基づき一定期間（30日）内に自動削除します。<br/>
                  （2）当社は、証跡として生年月日、審査結果、審査日時、審査担当者、書類種別、識別子（免許証番号のハッシュ等）等の必要最小限のテキスト情報のみを保存します。<br/>
                  （3）本条に基づく本人確認情報の保存・管理方法、保存期間、削除方針は、当社プライバシーポリシーに従います。<br/>
                  （4）利用者が誤って個人番号（マイナンバー）を含む画像を提出した場合、当社は当該部分を受領せず、又は速やかに削除します。
                </div>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-black">第8条（虚偽・不正時の措置）</h2>
                <div className="text-base sm:text-lg leading-relaxed">
                  （1）提出情報が虚偽、不正取得、第三者の書類の流用であると当社が判断した場合、当社はアカウントの停止・解約、コンテンツ削除、支払の保留・没収相当の相殺等、必要な措置を講じます。<br/>
                  （2）当社は、必要に応じて警察、関係当局、決済事業者等と連携し、情報提供その他の対応を行うことができます。
                </div>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-black">第9条（プライバシー情報の管理、保管期間）</h2>
                <div className="text-base sm:text-lg leading-relaxed">
                  （1）当社は、ユーザーが本サービスを利用している期間中、当該ユーザーから開示または提供されたプライバシー情報の漏洩、改ざん等を防止するため、現時点での技術水準に合わせた必要かつ適切な安全管理措置を講じます。<br/>
                  （2）当社は、当社が保管するプライバシー情報を利用する必要がなくなった場合、当該プライバシー情報を遅滞なく消去するよう努めるものとします。また、ユーザーよりプライバシー情報の削除を要求された場合も、同様とします。
                </div>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-black">第10条（ユーザーによる照会等への対応）</h2>
                <div className="text-base sm:text-lg leading-relaxed">
                  （1）ユーザーは、当社に対して、当社が保有する自身のプライバシー情報の開示、訂正、追加または削除、および利用停止を請求することができます。<br/>
                  （2）ユーザーは、当社が定める手段によって前項の開示等の請求をするものとします。なお、同請求は、ユーザー本人、法定代理人または当該請求につきユーザー本人より委任された代理人のみすることができます。<br/>
                  （3）当社は、開示等の請求を受けた場合、当社が定める手段によって本人確認したうえで、相当な期間内にこれに対応します。なお、当社は、法令に基づき開示等をしない決定をした場合、その旨をユーザーに通知するものとします。
                </div>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-black">第11条（解析ツール等の使用）</h2>
                <div className="text-base sm:text-lg leading-relaxed">
                  （1）当社は、アクセス解析ツールを使用してユーザーの行動履歴等に関する情報を収集します。また、本サービスの提供に係るウェブサイト上に掲載される広告等の一部は、Cookieを利用した第三者の運営するサービスを利用して表示されます。<br/>
                  （2）ユーザーは、自身のブラウザ設定等からCookieを無効にする、それぞれの解析ツール、行動ターゲティング広告システムに係るWEBページからオプトアウトする等の手段により当社によるプライバシー情報の収集を拒否することができます。<br/>
                  （3）前項の設定の変更等は、ユーザー自身の自己責任にてなされるものとし、当社は、設定を変更したこと等により一部の情報が閲覧できない等、ユーザーに損害が生じた場合でも、一切責任を負わないものとします。
                </div>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-black">第12条（SSL（Secure Socket Layer）について）</h2>
                <div className="text-base sm:text-lg leading-relaxed">
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-black">第13条（本ポリシーの変更）</h2>
                <div className="text-base sm:text-lg leading-relaxed">
                  （1）当社は、自身の判断にて、本ポリシーを改定することができます。当社は、本ポリシーを改定する場合、緊急性がある場合を除き、事前に当社が適当であると判断する手段にてユーザーにその旨を通知するものとします。<br/>
                  （2）本ポリシーの改定は、改定後のプライバシーポリシーを本サービスにかかるWEBサイト上に掲載した時点で効力を生じるものとします。<br/>
                  （3）ユーザーは、本ポリシーの改定に同意することができない場合、当社に対して自身のプライバシー情報の削除を要求することができます。
                </div>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-black">第14条（準拠法・管轄裁判所）</h2>
                <div className="text-base sm:text-lg leading-relaxed">
                  （1）本ポリシーは、日本国法に準拠して解釈されるものとします。<br/>
                  （2）ユーザーは、本ポリシーに関連して紛争等が発生した場合、東京地方裁判所において第一審の裁判を行うことにあらかじめ同意するものとします。
                </div>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-black">第15条（管理責任者）</h2>
                <div className="text-base sm:text-lg leading-relaxed">
                  当社では、個人情報の管理責任者を以下の者として、個人情報の適正な管理および個人情報保護に関する施策の継続的な改善を実施しています。なお、個人情報に関するお問い合わせ、ご相談、開示等の請求の窓口もこちらをご利用ください。<br/>
                  <div className="ml-4 sm:ml-6 mt-2">
                    運営者: Linkle株式会社<br/>
                    所在地: 〒150-0043 東京都渋谷区道玄坂1-12-1 渋谷マークシティW22階<br/>
